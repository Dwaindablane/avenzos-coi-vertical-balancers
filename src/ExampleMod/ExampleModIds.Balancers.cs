...
public partial class ExampleModIds 
{
    ...
    {
		public static readonly BalancerID BalancerVerticalLooseI1 = new BalancerID("BalancerVerticalLooseI1");
        public static readonly BalancerID BalancerVerticalLooseI2 = new BalancerID("BalancerVerticalLooseI2");
        public static readonly BalancerID BalancerVerticalLooseI3 = new BalancerID("BalancerVerticalLooseI3");
        public static readonly BalancerID BalancerVerticalLooseI4 = new BalancerID("BalancerVerticalLooseI4");

        public static readonly BalancerID BalancerVerticalFlatI1 = new BalancerID("BalancerVerticalFlatI1");
